  ...
  return (
    <div className="w-full max-w-4xl mx-auto overflow-x-hidden animate-fade-in">
      ...
      <div className="card-elevated rounded-2xl shadow-xl p-6 sm:p-8 md:p-10 space-y-8">
        {/* Acceptance */}
        <section>
          <h2 className="text-xl sm:text-2xl font-bold text-ink mb-3 flex items-center gap-3">
            <span className="flex-shrink-0 w-8 h-8 rounded-lg bg-accent text-ink-onAccent border border-ink/20 flex items-center justify-center text-sm font-bold">
              1
            </span>
            Acceptance of Terms
          </h2>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 pl-4 text-ink">
